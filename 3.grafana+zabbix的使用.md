...
cert证书abc.com~2020~7~2
cert证书123.com~2021~4~24
cert证书xixi.com~2020~10~24
cert证书haha.com~2020~6~28
```
...
cert证书abc.com还有5天到期
cert证书123.com还有9天到期
cert证书xixi.com还有6天到期
cert证书haha.com还有6天到期
```
...
表达式：
		...
		功能：{Zabbix server:ssl_expire_check.str(cert)}=1  #这里截取脚本中有cert输出，统计域名前都加cert

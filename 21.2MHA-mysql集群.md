...
mysql>grant all on *.* to root@'%' identified bty '123qqq...A';
#在从上验证是否修改成功
...
#MHA安装
#安装环境
yum install perl-DBD-MySQL perl-Config-Tiny perl-Log-Dispatch perl-Parallel-ForkManager perl-Time-HiRes   perl-Net-Telnet -y
#安装包
wget https://qiniu.wsfnk.com/mha4mysql-node-0.56-0.el6.centos.noarch.rpm

...
input {
        kafka{
                ...
                type => "public"
                auto_offset_reset => "earliest"  #用来消费最新的消息
        }
        kafka{
                bootstrap_servers => "192.168.220.7:9092,192.168.220.8:9092,192.168.220.9:9092"
                group_id => "logstash"
...
output {
        ...
        if [type] == "smoke" {
                elasticsearch{
                        ...
                        index => "smoke-log-%{+YYYY.MM.dd}"
                }
        }
        if [type] == "public" {
                elasticsearch{
                        hosts  => ["192.168.220.7:9200","192.168.220.8:9200","192.168.220.9:9200"]
                        index => "public-log-%{+YYYY.MM.dd}"
                }
        }
        ...
        if [type] == "plug" {
                elasticsearch{
                        hosts  => ["192.168.220.7:9200","192.168.220.8:9200","192.168.220.9:9200"]
                        index => "plug-log-%{+YYYY.MM.dd}"
                }
        }
        if [type] == "obiliquty" {
                elasticsearch{
                        hosts  => ["192.168.220.7:9200","192.168.220.8:9200","192.168.220.9:9200"]
                        index => "obiliquty-log-%{+YYYY.MM.dd}"
                }
        }
        if [type] == "park" {
                elasticsearch{
                        hosts  => ["192.168.220.7:9200","192.168.220.8:9200","192.168.220.9:9200"]
                        index => "park-log-%{+YYYY.MM.dd}"
                }
        }
